...
instance_create_depth(xMiddlePosition, yMiddlePosition - distanceBetweenButtons, 0, obj_BtnStartGame);
instance_create_depth(xMiddlePosition, yMiddlePosition, 0, obj_BtnFullScreen);
instance_create_depth(xMiddlePosition, yMiddlePosition + distanceBetweenButtons, 0, obj_BtnQuitGame);